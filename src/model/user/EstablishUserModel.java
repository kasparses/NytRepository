...
public class EstablishUserModel extends Model {
	...
	ResultSet rs;
	JsonClasses.EstablishUser EU = new JsonClasses.EstablishUser(stringToBeReturned, stringToBeReturned, 0, stringToBeReturned, stringToBeReturned, stringToBeReturned);
	...
	public String EstablishUser(
			...
			String[] keys = { "email", "Active", "password", "CPR", "UpdatedCbsEvents"};
			String[] values = { email, ac, password, CPR, UpdatedCbsEvents};
			try {
